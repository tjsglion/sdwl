...
function Page(_ref) {
    var pageSize = _ref.pageSize,
        ...
        prev = _ref.prev;
        next = _ref.next;
        first_last_flag = _ref.first_last_flag;
    if(!pageSize){
        pageSize = 0
    };
    if(!pageSize){
    ...
    this.prev = prev;
    this.next = next;
    this.first_last_flag = first_last_flag; // 是否显示首页或者尾页的标志
...
Page.prototype = {
    ...
    firstPage: function firstPage() {
        var that = this;
        if (!this.first_last_flag) return this;
        var li = document.createElement('li');
        li.innerHTML = '首页';
